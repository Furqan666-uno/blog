...
class SignUpForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs): # we do this to add widget to remaining fields 
...
class EditProfileForm(UserChangeForm):
    ...
    is_active= forms.BooleanField(required=False, widget= forms.CheckboxInput(attrs={'class':'form-check'}))
